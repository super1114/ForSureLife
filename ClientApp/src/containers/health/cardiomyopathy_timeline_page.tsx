...
class CardiomyopathyTimelinePageClass extends React.Component<Props, any> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardWrapper>
                    <QuestionDisplay
                        questionTitle={QuestionList.HealthQuestions.CardiomyopathyTimeline.Title}
                        questionText={QuestionList.HealthQuestions.CardiomyopathyTimeline.Text}
                    />
                    ...
                    <NavigationButtons
                        progressPercent={flow == LeadFlow.E ? 83 : 79}
                        hideNext
                        navigate={() => navigate(history, navRoutes.Health.LiverDisease.path)}
                    />
                </CardWrapper>
...
export const CardiomyopathyTimelinePage = connect(mapStateToProps, mapDispatchToProps)(CardiomyopathyTimelinePageClass);
