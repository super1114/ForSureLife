...
class HeartBrainTimelinePageClass extends React.Component<Props, any> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardWrapper>
                    <QuestionDisplay
                        questionTitle={QuestionList.HealthQuestions.HeartOrBrainProcedureTimeline.Title}
                        questionText={QuestionList.HealthQuestions.HeartOrBrainProcedureTimeline.Text}
                    />
                    ...
                    <NavigationButtons
                        progressPercent={flow == LeadFlow.E ? 63 : 48}
                        hideNext
                        navigate={() => navigate(history, navRoutes.Health.OutstandingTesting.path)}
                    />
                </CardWrapper>
            </div>
        )
...
export const HeartBrainTimelinePage = connect(mapStateToProps, mapDispatchToProps)(HeartBrainTimelinePageClass);
