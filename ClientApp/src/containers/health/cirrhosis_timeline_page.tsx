...
class CirrhosisTimelinePageClass extends React.Component<Props, any> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardWrapper>
                    <QuestionDisplay
                        questionTitle={QuestionList.HealthQuestions.CirrhosisTimeline.Title}
                        questionText={QuestionList.HealthQuestions.CirrhosisTimeline.Text}
                    />
                    ...
                    <NavigationButtons
                        progressPercent={flow == LeadFlow.E ? 48: 18}
                        hideNext
                        navigate={() => navigate(history, navRoutes.Health.HeartTimeline.path)}
                    />
                </CardWrapper>
            </div>
        )
...
export const CirrhosisTimelinePage = connect(mapStateToProps, mapDispatchToProps)(CirrhosisTimelinePageClass);
