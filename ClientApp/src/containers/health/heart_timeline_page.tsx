...
class HeartTimelinePageClass extends React.Component<Props, any> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardWrapper>
                    <QuestionDisplay
                        questionTitle={QuestionList.HealthQuestions.HeartTimeline.Title}
                        questionText={QuestionList.HealthQuestions.HeartTimeline.Text}
                    />
                    ...
                    <NavigationButtons
                        progressPercent={flow == LeadFlow.E ? 44 : 6}
                        hideNext
...
export const HeartTimelinePage = connect(mapStateToProps, mapDispatchToProps)(HeartTimelinePageClass);
