    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardWrapper>
                    <QuestionDisplay
                        questionTitle={QuestionList.ReviewQuestions.ReviewUpdateMenuOther.Title}
...
export const ReviewUpdateMenuOther = connect(mapStateToProps, mapDispatchToProps)(ReviewUpdateMenuClass);
