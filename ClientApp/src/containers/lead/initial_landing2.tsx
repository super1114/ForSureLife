...
export class LandingPage2Class extends React.Component<Props, State>{
                ...
                <Row justify="center">
                    ...
                    <Col md={16} xs={24}>
                        ...
                        <NavigationButtons
                            ...
                            hideProgress
                        />
                        <iframe src="../../videoask-LandingPage.html" style={{
...
export const InitialLanding2Page = connect(mapStateToProps, mapDispatchToProps)(LandingPage2Class);
