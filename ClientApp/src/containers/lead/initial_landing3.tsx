...
export class LandingPage3Class extends React.Component<Props, State>{
...
export const InitialLanding3Page = connect(mapStateToProps, mapDispatchToProps)(LandingPage3Class);
