...
export class LandingPage4Class extends React.Component<Props, State>{
...
export const InitialLanding4Page = connect(mapStateToProps, mapDispatchToProps)(LandingPage4Class);
