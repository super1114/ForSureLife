...
class HospiceCarePageClass extends React.Component<Props, any> {
  yes = () => {
      ...
      <div>
        <CardWrapper>
          <div className="d-flex justify-between flex-column h-100">
            <QuestionDisplay
              questionTitle={QuestionList.KnockoutQuestions.HospiceCare.Title}
              questionText={QuestionList.KnockoutQuestions.HospiceCare.Text}
            />
            <div>
              <YesNoAnswer
                yes={() => {
              ...
              <NavigationButtons
                ...
                progressPercent={8}
                hideNext
                activeCounter={QuestionList.KnockoutQuestions.HospiceCare.QuestionNumber}
                navigate={() =>
...
export const HospiceCarePage = connect(
  mapStateToProps,
  mapDispatchToProps
)(HospiceCarePageClass);
